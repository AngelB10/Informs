...
function MyNavbar() {
  ...
  const isActive = (path) => location.pathname === path ? "mb-0 rounded-[2px] text-[#0f0873] border-r-2 border-l-2 border-blue-500" : "border-none text-black";
    ...
    <nav className="flex gap-6 px-[1%] font-stretch-condensed shadow-md">
      ...
      <div className="mt-[14px]">
        <ul className="flex items-start p-0 gap-10 text-center text-[15px]">
          <li className="hover:border-l-2 hover:border-r-2 hover:border-blue-500 ">
